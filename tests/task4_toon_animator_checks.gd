...
func _run_checks() -> void:
	...
	_assert(player_instance.get_node_or_null("VisualRoot/Body") is Polygon2D, "Body should be Polygon2D")
	_assert(player_instance.get_node_or_null("VisualRoot/Head") is Polygon2D, "Head should be Polygon2D")
	_assert(player_instance.get_node_or_null("VisualRoot/LeftArm") is Line2D, "LeftArm should be Line2D")
	_assert(player_instance.get_node_or_null("VisualRoot/RightArm") is Line2D, "RightArm should be Line2D")
	_assert(player_instance.get_node_or_null("VisualRoot/LeftLeg") is Line2D, "LeftLeg should be Line2D")
	_assert(player_instance.get_node_or_null("VisualRoot/RightLeg") is Line2D, "RightLeg should be Line2D")
	_assert(player_instance.get_node_or_null("VisualRoot/LeftFoot") is Polygon2D, "LeftFoot should be Polygon2D")
	_assert(player_instance.get_node_or_null("VisualRoot/RightFoot") is Polygon2D, "RightFoot should be Polygon2D")
