...
func _run_checks() -> void:
	...
	if player_scene is PackedScene:
		...
		_assert(player_instance.get_node_or_null("VisualRoot/LeftArm") is Line2D, "Player LeftArm should be Line2D")
		_assert(player_instance.get_node_or_null("VisualRoot/RightArm") is Line2D, "Player RightArm should be Line2D")
		_assert(player_instance.get_node_or_null("VisualRoot/LeftLeg") is Line2D, "Player LeftLeg should be Line2D")
		_assert(player_instance.get_node_or_null("VisualRoot/RightLeg") is Line2D, "Player RightLeg should be Line2D")
		_assert(player_instance.has_node("VisualRoot/Head/Eyes/LeftEye"), "Player should include left eye visual under Head/Eyes")
